...
public class VideoGameDbTestSuite {
    ...
    public void testSaveManyToMany(){
        ...
        VideoGame wow= new VideoGame("World for Warcraft: Battle of Azeroth","The seventh expansion for World of Warcraft, focusing on the rivalry between the two most important " +
